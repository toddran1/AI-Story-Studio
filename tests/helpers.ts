...
export const testStory = (overrides: Partial<Story["pipeline"]> = {}): Story => ({
  ...
  context: { recentChapterSummaries: 5 }, narrationSettings: { profanityMode: "preserve" }, audio: { loudnessTarget: -17, truePeak: -1.5, segmentGapSeconds: 0.35, chapterGapSeconds: 1.5, format: "mp3", bitrate: "128k", sampleRate: 44100 }, pipeline: {
