...
export const batchStateSchema = z.object({
  ...
  options: z.object({ allowGaps: z.boolean(), continueOnError: z.boolean(), delayMs: z.number(), force: z.string().optional(), stopAfter: z.string().optional(), stage: z.string().optional(), mode: z.preprocess((value) => value === "through" ? "prerequisites" : value, z.enum(["selected", "prerequisites"])).optional() }),
