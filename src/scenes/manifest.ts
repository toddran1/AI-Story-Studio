...
export function sceneContentFingerprint(scene: Pick<Scene, "summary" | "startSeconds" | "endSeconds" | "characters" | "location" | "visualPrompt" | "importance"> & { direction?: Scene["direction"]; overrides?: Scene["overrides"]; visualChanges?: Scene["visualChanges"] }) {
  return fingerprint({ summary: scene.summary, startSeconds: scene.startSeconds, endSeconds: scene.endSeconds, characters: scene.characters, location: scene.location, visualPrompt: scene.visualPrompt, importance: scene.importance, direction: scene.direction, overrides: scene.overrides, visualChanges: scene.visualChanges });
}
