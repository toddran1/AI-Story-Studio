...
export type Job = { id: string; type: "batch" | "preview" | "voicePreview" | "metadataTranslation" | "qaRepair" | "qaRecheck" | "summary" | "audio" | "audiobook" | "alignment" | "subtitles" | "video" | "videoExport" | "scenes" | "artwork" | "production"; story: string; status: JobStatus; createdAt: string; updatedAt: string; progress?: unknown; result?: unknown; error?: string; diagnostic?: ErrorDiagnostic };
