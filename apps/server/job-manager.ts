...
export type Job = { id: string; type: "batch" | "preview" | "audio" | "audiobook" | "subtitles" | "video" | "videoExport" | "scenes" | "artwork"; story: string; status: JobStatus; createdAt: string; updatedAt: string; progress?: unknown; result?: unknown; error?: string };
