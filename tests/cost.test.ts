...
describe("cost calculation",()=>{
  ...
  it("prices GPT-6 Sol and Luna using the published standard token rates", () => {
    expect(calculateCost(pricingFor("openai", "gpt-6-sol"), { inputTokens: 1_000_000, cachedInputTokens: 250_000, outputTokens: 100_000 })).toBe(2.55);
    expect(calculateCost(pricingFor("openai", "gpt-6-luna"), { inputTokens: 1_000_000, cachedInputTokens: 250_000, outputTokens: 100_000 })).toBe(.1275);
  });
